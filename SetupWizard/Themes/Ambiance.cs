...
namespace Ambiance
{
    ...
    class Ambiance_TextBox : Control
    {
        ...
        private Color _borderActiveColor=Color.FromArgb(205, 87, 40);

        private Color _borderNormalColor = Color.FromArgb(180, 180, 180);
        #endregion
        #region Properties
        ...
        {
            get { return _borderNormalColor; }
            set { _borderNormalColor = value; }
        }
        ...
        {
            P1 = new Pen(BorderActiveColor);
            Refresh();
        }

        private void _Leave(object Obj, EventArgs e)
        {
            P1 = new Pen(BorderNormalColor);
            Refresh();
        }
