...
namespace SetupWizard
{
    sealed class ColorSchema
    {
        ...
        public static Color CaptionColor = Color.FromArgb(42, 126, 230);

        public static Color BackColor = Color.FromArgb(244, 244, 244);

        public static Color Control = Color.FromArgb(255,255,255);


        public static Color ControlActiveColor = Color.FromArgb(246,155,0);

        public static Color ButtonActiveColor = Color.FromArgb(182,27,11);
        public static Color ForeColor = Color.White;
        public static Color BorderColor = Color.FromArgb(206, 210, 214);
    ...
    public class MonoFlatBlue_ThemeContainer : ContainerControl
    {
        ...
        private bool _CoverBackground = true;
        public bool CoverBackground
        {
            get
            {
                return _CoverBackground;
            }
            set
            {
                //if (value)
                //{
                //    this.BackColor = this.CaptionBackColor;
                //}
                //else
                //{
                //    this.BackColor = ColorSchema.Window;
                //}

                _CoverBackground = value;
                Invalidate();
            }
        }

        private Color _CaptionBackColor;
        public Color CaptionBackColor { get {
        ...
        protected sealed override void OnParentChanged(EventArgs e)
        {
            ...
            if (!_ControlMode)
            {
                ...
                if (_IsParentForm)
                {
                    ...
                    if (!RoundCorners)
                    {
                        this.ParentForm.Padding = new Padding(1);
                    }
                    else
                    { 
                        //todo:
        ...
        public MonoFlatBlue_ThemeContainer()
        {
            SetStyle((ControlStyles)(139270), true);
            BackColor = ColorSchema.Window;
            CaptionBackColor = ColorSchema.CaptionColor;
            DoubleBuffered = true;
            Dock = DockStyle.Fill;
            MoveHeight = 66;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            {
                G.Clear(this.BackColor);
                G.FillRectangle(new SolidBrush(this.CaptionBackColor), new Rectangle(0, 0, Width, 60));
            }
            ...
            if (_RoundCorners == true)
            {
                ...
                G.FillRectangle(new SolidBrush(ColorSchema.CaptionColor), 1, 3, 1, 1);
                G.FillRectangle(new SolidBrush(ColorSchema.CaptionColor), 1, 2, 1, 1);
                G.FillRectangle(new SolidBrush(ColorSchema.CaptionColor), 2, 1, 1, 1);
                G.FillRectangle(new SolidBrush(ColorSchema.CaptionColor), 3, 1, 1, 1);
                ...
                G.FillRectangle(new SolidBrush(ColorSchema.CaptionColor), Width - 2, 3, 1, 1);
                G.FillRectangle(new SolidBrush(ColorSchema.CaptionColor), Width - 2, 2, 1, 1);
                G.FillRectangle(new SolidBrush(ColorSchema.CaptionColor), Width - 3, 1, 1, 1);
                G.FillRectangle(new SolidBrush(ColorSchema.CaptionColor), Width - 4, 1, 1, 1);
                ...
                G.FillRectangle(new SolidBrush(ColorSchema.Window), 1, Height - 3, 1, 1);
                G.FillRectangle(new SolidBrush(ColorSchema.Window), 1, Height - 4, 1, 1);
                G.FillRectangle(new SolidBrush(ColorSchema.Window), 3, Height - 2, 1, 1);
                G.FillRectangle(new SolidBrush(ColorSchema.Window), 2, Height - 2, 1, 1);
                ...
                G.FillRectangle(new SolidBrush(ColorSchema.Window), Width - 2, Height - 3, 1, 1);
                G.FillRectangle(new SolidBrush(ColorSchema.Window), Width - 2, Height - 4, 1, 1);
                G.FillRectangle(new SolidBrush(ColorSchema.Window), Width - 4, Height - 2, 1, 1);
                G.FillRectangle(new SolidBrush(ColorSchema.Window), Width - 3, Height - 2, 1, 1);
            }

            if (ShowCaption)
            {
                G.DrawString(this.Text, new Font("Microsoft Sans Serif", 12, FontStyle.Bold), new SolidBrush(Color.FromArgb(255, 254, 255)), new Rectangle(20, 20, Width - 1, Height), new StringFormat() { Alignment = StringAlignment.Near, LineAlignment = StringAlignment.Near });
            }
    ...
    class MonoFlatBlue_ControlBox : Control
    {
        ...
        private Color ButtonBackColor = Color.FromArgb(182,27,11);
        ...
        public bool ShowMaxmizeButton { get; set; }
        ...
        public MonoFlatBlue_ControlBox()
            : base()
        {
            DoubleBuffered = true;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            base.OnPaint(e);
            Graphics G = e.Graphics;
            //G.Clear(ColorSchema.CaptionColor);
                ...
                switch (ButtonHState)
                {
                    ...
                    case ButtonHoverState.Minimize:
                        if (ShowMinimizeButton)
                        {
                            if (_EnableMinimize == true)
                            {
                                G.FillRectangle(new SolidBrush(ButtonBackColor), new Rectangle(3, 0, 30, Height));
                            }
                        }
                        break;
                    case ButtonHoverState.Maximize:
                        if (ShowMaxmizeButton)
                        {
                            if (_EnableMaximize == true)
                            {
                                G.FillRectangle(new SolidBrush(ButtonBackColor), new Rectangle(35, 0, 30, Height));
                            }
                        }
                        break;
                    case ButtonHoverState.Close:
                        G.FillRectangle(new SolidBrush(ButtonBackColor), new Rectangle(66, 0, 35, Height));
                        break;
                }
            }

            // 关闭按钮
            G.DrawString("r", new Font("Marlett", 12), new SolidBrush(Color.FromArgb(255, 254, 255)), new Point(Width - 16, 5), new StringFormat { Alignment = StringAlignment.Center });
            ...
            if (ShowMaxmizeButton)
            {
                switch (Parent.FindForm().WindowState)
                {
                    case FormWindowState.Maximized:
                        if (_EnableMaximize == true)
                        {
                            G.DrawString("2", new Font("Marlett", 12), new SolidBrush(Color.FromArgb(255, 254, 255)), new Point(51, 5), new StringFormat { Alignment = StringAlignment.Center });
                        }
                        else
                        {
                            G.DrawString("2", new Font("Marlett", 12), new SolidBrush(Color.LightGray), new Point(51, 5), new StringFormat { Alignment = StringAlignment.Center });
                        }
                    ...
                    case FormWindowState.Normal:
                        if (_EnableMaximize == true)
                        {
                            G.DrawString("1", new Font("Marlett", 12), new SolidBrush(Color.FromArgb(255, 254, 255)), new Point(51, 5), new StringFormat { Alignment = StringAlignment.Center });
                        }
                        else
                        {
                            G.DrawString("1", new Font("Marlett", 12), new SolidBrush(Color.LightGray), new Point(51, 5), new StringFormat { Alignment = StringAlignment.Center });
                        }
                        break;
                }
            }
            ...
            if (ShowMinimizeButton)
            {
                if (_EnableMinimize == true)
                {
                    G.DrawString("0", new Font("Marlett", 12), new SolidBrush(Color.FromArgb(255, 254, 255)), new Point(20, 5), new StringFormat { Alignment = StringAlignment.Center });
                }
                else
                {
                    G.DrawString("0", new Font("Marlett", 12), new SolidBrush(Color.LightGray), new Point(20, 5), new StringFormat { Alignment = StringAlignment.Center });
                }
            }
        }
    }
    ...
    public class MonoFlatBlue_Button : Control
    {
        ...
        private Color _ButtonFaceColor;
        public Color ButtonFaceColor { get{
            return _ButtonFaceColor;
        } set{
            
            _ButtonFaceColor = value;

                InactiveGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), ButtonFaceColor, ButtonFaceColor, 90.0F);
            Invalidate();
        } }

        private Color _ButtonPressColor;
        public Color ButtonPressColor { get {
            return _ButtonPressColor;
        }
            set {
                _ButtonPressColor = value;
                PressedGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), ButtonPressColor, ButtonPressColor, 90.0F);
                Invalidate();
            }
        }
        ...
        public MonoFlatBlue_Button()
        {
            ...
            ButtonFaceColor = ColorSchema.CaptionColor;
            ButtonPressColor = ColorSchema.ButtonActiveColor;
            BorderColor = ColorSchema.ChangeColor(ButtonFaceColor, 0.5f);
            BorderPressColor = ColorSchema.ChangeColor(ButtonPressColor, 0.5f);
        ...
        protected override void OnResize(System.EventArgs e)
        {
            ...
            if (Width > 0 && Height > 0)
            {
                ...
                //InactiveGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), this.ButtonFaceColor1, this.ButtonFaceColor2, 90.0F);
                //PressedGB = new LinearGradientBrush(new Rectangle(0, 0, Width, Height), ButtonPressColor, ButtonPressColor, 90.0F);
            }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            switch (MouseState)
            {
                ...
                case 1:
                    ...
                    using (Pen borderPen = new Pen(BorderPressColor))
                    {
                        G.DrawPath(borderPen, Shape);
                    }
                    ...
                    if ((Image == null))
                    {
                        G.DrawString(Text, Font, new SolidBrush(PressForeColor), R1, new StringFormat
                        {
                            Alignment = _TextAlignment,
                            LineAlignment = StringAlignment.Center
                        });
    ...
    public class MonoFlatBlue_SocialButton : Control
    {
        ...
        {
            base.OnMouseEnter(e);
            EllipseColor = ColorSchema.CaptionColor;
            Refresh();
        }
        protected override void OnMouseLeave(EventArgs e)
        {
            base.OnMouseLeave(e);
            EllipseColor = ColorSchema.Control;
            Refresh();
        }
        ...
        public MonoFlatBlue_SocialButton()
        {
            DoubleBuffered = true;
            EllipseColor = ColorSchema.Control;
        }
    ...
    public class MonoFlatBlue_Label : Label
    {

        public MonoFlatBlue_Label()
        {
            Font = new Font("Segoe UI", 9);
            ForeColor = ColorSchema.ForeColor;
            BackColor = Color.Transparent;
        }
    }
    ...
    #endregion
    #region  Link Label
    public class MonoFlatBlue_LinkLabel : LinkLabel
    {

        public MonoFlatBlue_LinkLabel()
        {
            Font = new Font("Segoe UI", 9, FontStyle.Regular);
            BackColor = Color.Transparent;
            LinkColor = ColorSchema.CaptionColor;
            ActiveLinkColor = ColorSchema.ButtonActiveColor;
            VisitedLinkColor = ColorSchema.CaptionColor;
    ...
    public class MonoFlatBlue_HeaderLabel : Label
    {

        public MonoFlatBlue_HeaderLabel()
        {
    ...
    public class MonoFlatBlue_Toggle : Control
    {
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            G.FillPath(new SolidBrush(ColorSchema.Control), GP);
            G.FillPath(new SolidBrush(ColorSchema.Window), GP2);
            ...
            if (_Toggled)
            {
                ...
                GP2 = RoundRectangle.RoundRect(ThumbRect, 4);
                G.FillPath(new SolidBrush(ColorSchema.CaptionColor), GP);
                G.FillPath(new SolidBrush(ColorSchema.Window), GP2);
            }
    ...
    public class MonoFlatBlue_CheckBox : Control
    {
        ...
        public Color CheckColor { get; set; } = Color.Empty;
        public Color CheckBgColor { get; set; }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            {
                borderPen = new Pen(ColorSchema.BorderColor, 1);
            }

            if (_Checked)
            {
                if (CheckBgColor != Color.Empty)
                {
                    using (var bgb = new SolidBrush(CheckBgColor)) {
                        //G.FillRectangle(bgb, new Rectangle(2, 2, 16, 16));
                        G.FillRoundedRectangle(bgb, new Rectangle(0, 0, 16, 15), 4);
                        G.DrawRoundedRectangle(borderPen, new Rectangle(0, 0, 15, 15), 4);
                    }
                }
                else
                {
                    G.FillRectangle(new SolidBrush(ColorSchema.Control), new Rectangle(0, 0, 16, 16));
                    G.FillRectangle(new SolidBrush(ColorSchema.Control), new Rectangle(1, 1, 16 - 2, 16 - 2));
                    G.DrawRectangle(borderPen, new Rectangle(0, 0, 16, 15));
                }
            ...
            else
            {
                if (CheckBgColor != Color.Empty)
                {
                    using (var bgb = new SolidBrush(Color.White))
                    {
                        G.FillRectangle(bgb, new Rectangle(0, 0, 16, 16));
                        G.FillRectangle(bgb, new Rectangle(1, 1, 16 - 2, 16 - 2));
                        G.DrawRoundedRectangle(borderPen, new Rectangle(0, 0, 16, 15), 4);
                    }
                }
                else
                {
            ...
            if (Enabled == true)
            {
                if (_Checked)
                {
                    G.DrawString("a", new Font("Marlett", 16), new SolidBrush(
                        CheckColor == Color.Empty ? ColorSchema.CaptionColor : CheckColor), new Point(-5, -3));
                }
            }
            else
            {
            ...
            G.DrawString(Text, Font, new SolidBrush(this.ForeColor), new Point(20, 0));
    ...
    [DefaultEvent("CheckedChanged")]
    public class MonoFlatBlue_RadioButton : Control
    {
        ...
        public MonoFlatBlue_RadioButton()
        {
            Width = 159;
            Height = 17;
            DoubleBuffered = true;
        ...
        private void InvalidateControls()
        {
            ...
            {
                if (_Control != this && _Control is MonoFlatBlue_RadioButton)
                {
                    ((MonoFlatBlue_RadioButton)_Control).Checked = false;
                }
            }
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            G.FillEllipse(new SolidBrush(ColorSchema.Control), new Rectangle(0, 0, 16, 16));

            if (_Checked)
            {
                G.DrawString("a", new Font("Marlett", 15), new SolidBrush(ColorSchema.CaptionColor), new Point(-3, -2));
            }
    ...
    public class MonoFlatBlue_TextBox : Control
    {
        ...
        {
            P1 = new Pen(ColorSchema.CaptionColor);
            Refresh();
        }

        private void _Leave(object Obj, EventArgs e)
        {
            P1 = new Pen(ColorSchema.Window);
            Refresh();
        }
        ...
        public void AddTextBox()
        {
            ...
            MonoFlatTB.BackColor = ColorSchema.Control;
        ...
        public MonoFlatBlue_TextBox()
        {
            ...
            P1 = new Pen(ColorSchema.Window);
            B1 = new SolidBrush(ColorSchema.Control);
            BackColor = Color.Transparent;
    ...
    public class MonoFlatBlue_Panel : ContainerControl
    {

        private GraphicsPath Shape;

        public MonoFlatBlue_Panel()
        {
            SetStyle(ControlStyles.SupportsTransparentBackColor, true);
            SetStyle(ControlStyles.UserPaint, true);
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            G.Clear(this.BackColor); // Set control background to transparent
            G.FillPath(new SolidBrush(ColorSchema.BackColor), Shape); // Draw RTB background
            G.DrawPath(new Pen(ColorSchema.BackColor), Shape); // Draw border
    ...
    public class MonoFlatBlue_Separator : Control
    {

        public MonoFlatBlue_Separator()
        {
    ...
    public class MonoFlatBlue_TrackBar : Control
    {
    ...
    public class MonoFlatBlue_NotificationBox : Control
    {
        ...
        public MonoFlatBlue_NotificationBox()
        {
