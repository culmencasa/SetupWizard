...
namespace System.Windows.Forms
{
    /// <summary>
    /// 阴影窗体
    /// 比DwmExtendFrameIntoClientArea好,支持圆角, 支持XP
    /// </summary>
    public class DropShadow : Form
    {
        ...
        private Bitmap DrawShadow()
        {
            ...
            Color fadeColor = Color.FromArgb(140, 0, 0,0);
            // 层叠第二个阴影
            wrapRect.Inflate(3, 3);
            fadeColor = Color.FromArgb(18, 0, 0, 0);
            DrawFadeRectangle(g, wrapRect, fadeColor, this.ShadowRadius + 20);
            // 层叠第三个阴影
            wrapRect.Inflate(2, 2);
            fadeColor = Color.FromArgb(6, 0, 0, 0);
